  ...
  _createClass(Calculator, [{
    ...
    value: function addDecimalSep(value) {
      ...
      if (!this.hasDecimals(value)) {
        value = value + _constants.default.DECIMAL_SEP;
      }
    ...
    value: function calculate(operation) {
      ...
      switch (len) {
        ...
        case 3:
          ...
          this._lastOperated = this._operationElements[2]; // Fazer o parse dos dos elementos da operação e executar cálculo
    ...
    value: function captureOperation(value) {
      ...
      if (this.isOperator(this.lastOperationElement)) {
        ...
        if (this.isOperator(value)) {
          ...
          this.pushOperation('0' + _constants.default.DECIMAL_SEP); // Adicionar novo elemento à operação como número, se um número foi digitado
        } else if (!isNaN(value)) {
        ...
        if (this.isOperator(value)) {
          ...
          if (value === _constants.default.DECIMAL_SEP) {
            this._operationElements = ['0' + _constants.default.DECIMAL_SEP]; // Adicionar novo elemento à operação como número, se um número foi digitado
          } else if (!isNaN(value)) {
...
},{"./Calculator":"scripts/Calculator.js"}],"C:/Users/julio/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
},{}]},{},["C:/Users/julio/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","scripts/main.js"], null)
